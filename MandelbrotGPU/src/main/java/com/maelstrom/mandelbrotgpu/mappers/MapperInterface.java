...
public interface MapperInterface {
    BufferedImage createProgramAndImage(final FractalSettings settings, final int colorSchemeID);
    ...
    BufferedImage createImage(final FractalSettings settings, final int colorSchemeID);
}
